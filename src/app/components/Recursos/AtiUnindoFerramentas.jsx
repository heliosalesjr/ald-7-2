  ...
  return (
    <div className=''>
        <div className='max-w-7xl mx-auto p-4  py-8'>
                <div className=''>
                    <h1 className='font-bold text-3xl py-4 text-slate-700'>Unindo ferramentas</h1>
                    ...
                    className='text-blue-700 underline py-2 hover:text-purple-900'
                    >
                    (apresentadas aqui)
                ...
                <div className="absolute top-0 left-0 md:w-4/5 w-full h-full bg-gradient-to-r from-primary to-primary-focus z-0"></div>
